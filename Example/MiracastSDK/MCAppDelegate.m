...
//  Miracast
//
//  Created by Kun Wang on 2018/6/29.
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    MCBrowserViewController *demo = [[MCBrowserViewController alloc] initWithURL:@"www.bilibili.com"];
    ...
    //拦截网络请求（Optional）
    [NSURLProtocol registerClass:[RTTURLProtocol class]];
    return YES;
}
